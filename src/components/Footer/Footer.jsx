    ...
    <footer className="  mt-[180px] flex h-44 w-full flex-row items-end  justify-between bg-color-verde pl-4 pt-7 pr-5 pb-8 md:pb-5">
      ...
      <div>
        <div className="flex w-16 flex-wrap gap-2.5 md:w-full ">
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=someone@example.com&su=SUBJECT&body=BODY&bcc=someone.else@example.com">
            <img src={gmailIcon} alt="" />
          </a>
          <a href="https://api.whatsapp.com/send/?phone=5492302554639&text=Hola">
